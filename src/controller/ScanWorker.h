...
namespace JTAG {
    ...
    private:
        ...
        std::atomic<int> pollIntervalMs{ 100 };  // Intervalo de polling (default: 10 samples/s)
        ...
        std::queue<std::pair<size_t, PinLevel>> dirtyPins;  // Cola FIFO para preservar cambios rápidos
