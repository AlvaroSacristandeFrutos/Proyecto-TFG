...
/**
 * @brief Raspberry Pi Pico JTAG Adapter (STUB - NOT IMPLEMENTED)
 *
 * WARNING: This adapter is a STUB for future implementation.
 * Only basic USB detection is functional. JTAG operations require:
 * - Custom firmware on the Pico
 * - Serial protocol implementation
 * - Full testing with real hardware
 *
 * Current status:
 * - ✓ USB detection (VID/PID)
 * - ✓ Serial port enumeration
 * - ✗ JTAG communication (throws exceptions)
 * - ✗ scanIR/scanDR/readIDCODE (not implemented)
 *
 * Do NOT use this adapter for production.
 */
